$(function () {
  ...
  function success(position) {
    ...
    img.src = 'https://maps.googleapis.com/maps/api/staticmap?center=' + latitude + ',' + longitude + '&markers=color:red|' + latitude + ',' + longitude + '&zoom=12&size=600x300&scale=2&sensor=true';
