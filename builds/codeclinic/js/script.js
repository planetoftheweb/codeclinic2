$(function() {
  ...
  appNode.style.backgroundSize =
    appWidth / scaleFrequencies.length * 2 +
    'px 100%';
  ...
  if (contextClass) {
    ...
    document.querySelector('.app').innerHTML =
      '<div class="container alert alert-danger" role="alert">Sorry, this app requires the Web Audio API, which your browser does not support.</div>';
  }

  appNode.addEventListener(
    'mousedown',
    function(e) {
      mouseXpos = e.clientX;
      mouseYpos = e.clientY;
      ...
      myDistortion.curve = makeDistortionCurve(
        400
      );
